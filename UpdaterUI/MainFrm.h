...
public:
	...
	BEGIN_MSG_MAP(CMainFrame)
		...
		COMMAND_HANDLER_EX(IDC_BUTTON_EXIT, BN_CLICKED, OnExitButtonClicked)
	...
	void OnExitButtonClicked(UINT /*uNotifyCode*/, int /*nID*/, CWindow /*wndCtl*/);
	void DoLayout();
